...
import ma.zakaria.spring.springprojettp.entité.StatusRDV;
import ma.zakaria.spring.springprojettp.repository.MedecinRepository;
import ma.zakaria.spring.springprojettp.repository.PatientRepository;
import ma.zakaria.spring.springprojettp.repository.RendezVousRepository;
...
public class SpringApplication  {
  ...
  /*  @Override
    public void  run(String... args) throws Exception {
        ...
        patientRepository.save(new Patient(null,"Zakaria",new Date("01/02/1999"),false,60,null));
    ...
    @Bean
        ...
        return args -> {
           ...
           // Patient patient1 = patientRepository.findByNomContaining("Zakaria");
